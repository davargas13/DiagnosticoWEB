namespace DiagnosticoWeb.Code.Curp
{
    ...
    public class Curp
    {
        ...
        public Curp(string nombres, string paterno, string materno, string sexo, DateTime fechaNacimiento, Estado estado)
        {
        ...
        private string CalculaCurp()
        {
            ...
            var sexo = this.Sexo.ToCharArray()[0];
